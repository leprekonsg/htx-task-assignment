...
//
// The frame is built like the top of a printed sheet rather than like an app chrome bar. The
// wordmark is set small, spaced and in the ink plate; under it, a monospace line says plainly what
// the thing does. The whole band is closed by a single heavy rule, which is the app's one
// structural gesture — the same rule reappears under each page's title and between table rows, at
// decreasing weights. Using one gesture at three weights is what makes the app feel like one
// document instead of a set of screens.
//
      ...
      <header className="border-b-2 border-text bg-surface-raised">
        <div className="mx-auto flex max-w-5xl flex-wrap items-end justify-between gap-x-8 gap-y-4 px-4 py-5 sm:px-6">
          <div className="flex flex-col gap-1.5">
            <NavLink
              to="/"
              className="text-sm font-bold uppercase tracking-[0.2em] text-text transition-colors hover:text-accent"
            >
              Task Assignment
            </NavLink>
